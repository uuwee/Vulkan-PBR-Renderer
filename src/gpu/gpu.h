...
typedef struct GPU_GraphicsPipelineDesc {
	...
	GPU_Format* vertex_input_formats;
	uint32_t vertex_input_formats_count;
...
GPU_API void GPU_DestroyDescriptorArena(GPU_DescriptorArena* descriptor_arena); // `descriptor_arena` may be NULL
